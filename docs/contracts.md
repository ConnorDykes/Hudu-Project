...
- Visual direction: polished desktop utility suite named **Hudu / Network Lookup** and **Hudu / Process Manager**. Dark ink/navy surfaces, mint accent, warm off-white text, generous spacing, restrained thin borders, excellent tables and error states. Real functionality and readable data first. Responsive at 960x680 through 1440x1000. Desktop shell sidebar/nav, header with small eyebrow, title, subtitle and optional actions. Avoid generic counter-app design.
